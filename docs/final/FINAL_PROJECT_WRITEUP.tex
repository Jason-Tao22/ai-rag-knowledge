...
\begin{itemize}[leftmargin=*]
    \item \textbf{Yifan Tao}: project planning, RAG system implementation, TechQA corpus preparation, documentation coordination, demo query preparation, and final report/presentation drafting.
    \item \textbf{Letong Yi}: GCP deployment, public endpoint setup, infrastructure support, endpoint testing, and presentation/report preparation.
\end{itemize}

Please adjust these contribution bullets before final submission if the actual division of labor changes.
